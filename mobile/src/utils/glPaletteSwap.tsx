  ...
  return (
    <GLView
      ...
      onContextCreate={(gl) => {
        ...
        // Ensure image is uploaded with the correct orientation and alpha handling
        // Flip Y because GL textures have different origin than image data
        try {
          gl.pixelStorei(gl.UNPACK_FLIP_Y_WEBGL, true)
        } catch (e) {
          // some GL backends may not support this; ignore
        }
        // Avoid automatic premultiplication that can cause halos around transparent pixels
        try {
