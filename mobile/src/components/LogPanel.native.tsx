...
import { renderDeltaPills } from "@shared/utils/ui.native"
...
const styles = StyleSheet.create({
  ...
  scroll: { flex: 1 },
  monthLabel: { color: "#8e93a8", fontSize: 12, marginBottom: 6, letterSpacing: 0.2 },
  logCard: { paddingVertical: 8, borderBottomWidth: 1, borderColor: "#1c2233", gap: 4 },
